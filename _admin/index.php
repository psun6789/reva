...
<head>
	...
	<title>Reva University - Admin DashBoard</title>
	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><span>Reva University</span> &nbsp; Admin</a>

				<!--Navigation bar right corner content start -->
				<ul class="nav navbar-top-links navbar-right">

					
				</ul>
				<!--Navigation bar right corner content end -->
